...
class ViewHasilAdminPage extends StatelessWidget {
  const ViewHasilAdminPage({Key? key}) : super(key: key);
  ...
  Widget viewHasil(){
    return ViewModelBuilder<RiwayatViewModel>.reactive(
      ...
      onModelReady: (model) => model.initHasil(),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        TextWidget(
                            desc: 'Klik detail untuk mengubah status hasil test covid 19',
                            textAlign: TextAlign.center,
                            style: MainTextStyle()
                                .textStyleBody1
                        ),
                            ...
                            rows: List<DataRow>.generate(
                              model.listRiwayat.length,
                                ...
                                return DataRow(cells: [
                                  DataCell(
                                    TextWidget(
                                        desc: data['id_daftar']?.toString() ?? '',
                                        textAlign: TextAlign.center,
                                        style: MainTextStyle().textStyleBody1),
                                  ),
                                  DataCell(
                                    TextWidget(
                                        desc: data['nm_pasien']?.toString() ?? '',
                                        textAlign: TextAlign.center,
                                        style: MainTextStyle().textStyleBody1),
                                  ),
                                  DataCell(
                                    TextWidget(
                                        desc: data['jns_test']?.toString() ?? '',
                                        textAlign: TextAlign.center,
                                        style: MainTextStyle().textStyleBody1),
                                  ),
                                  DataCell(
                                    TextWidget(
                                        desc: model.formatTanggal(data['tgl_test']?.toString() ?? '', data['jam_test']?.toString() ?? ''),
                                        textAlign: TextAlign.center,
                                        textOverflow: TextOverflow.visible,
                                        style: MainTextStyle().textStyleBody1),
                                  ),
                                  ...
                                  DataCell(
                                      Padding(
                                        ...
                                        child: ButtonWidget(
                                          ...
                                          onPressed: () {
                                            model.idDaftar = data['id_daftar']?.toString() ?? '';
                                            model.getDetailHasilAdminPasien();
                                          },
                                        ),
                                      )
                                  )
