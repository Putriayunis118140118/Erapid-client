...
class ViewHasilDetailAdminPage extends StatelessWidget {
  final String? idDaftar;
  const ViewHasilDetailAdminPage({Key? key, this.idDaftar}) : super(key: key);
            ...
            children: [
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    TextWidget(
                      desc: 'Update status test lab covid 19',
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  ...
                                  Visibility(
                                    visible: model.statusHasil.toUpperCase() != 'BELUM TEST',
                                    child: SizedBox(
                                      width: 200,
                                      height: 30,
                                      child: ButtonWidget(
                                        text: TextWidget(
                                          desc: "Lihat Hasil Lab",
                                          textAlign: TextAlign.center,
                                          style: MainTextStyle()
                                              .textStyleBody1
                                              .copyWith(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Row(
                    children: [
                      Radio<PilihanHasil>(
                        value: PilihanHasil.negatif,
                        groupValue: model.pilihanHasil,
                        onChanged: (PilihanHasil? value) {
                          model.pilihanHasil = value!;
                          model.notifyListeners();
                        },
                      ),
                      TextWidget(
              ...
              TextFieldWidget(
                textHint: 'Masukkan Informasi Tambahan',
                textController: model.txtInfoTambahan,
                inputFormatters: CoreValidation.formatTextNormal(),
                textAlign: TextAlign.left,
                textInputType: CoreValidation.typeString(),
                isValidation: true,
              ...
              Container(
                ...
                child: ButtonWidget(
                  text: TextWidget(
                    desc: "Update Status Lab",
                    textAlign: TextAlign.center,
                    style: MainTextStyle().textStyleButton,
                  ),
                  onPressed: model.statusHasil.toUpperCase() != 'BELUM TEST'
                      ? null
                      : () {
                          model.updateStatusHasil();
                        },
                ),
              ),
              const SizedBox(
